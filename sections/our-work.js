  ...
  const projects = [
    {
      ...
      role: "CRM / customer portal",
      review:
        "A custom portal built to organize quote requests, customer details, project notes, and follow-up in one cleaner system."
    },
    {
      title: "Momentum Athlete",
      client: "Momentum Athlete",
      role: "21-course credit platform",
      review:
        "A structured course system built to make the program easier to present, easier to understand, and easier for users to move through."
    },
    {
      title: "Orynd AI",
      client: "Orynd AI",
      role: "AI software experience",
      review:
        "An AI product flow shaped to make the software feel clearer, easier to explain, and easier for customers to use."
    },
    {
      title: "3D Install Tool",
      client: "Wonder World Playsets",
      role: "Interactive installation guide",
      review:
        "A 3D install manual built to help customers and installers visualize how the playset comes together before and during the build."
    }
  ];
